    ...
    <div class="col-sm-12">
        <div class="float-right page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="?module=peminjaman">Data Buku Perpus</a></li>
...
<div class="row">
    <div class="col-12">
        <div class="card m-b-30">
            <div class="card-body">
                <h4 class="mt-0 header-title">Form Tambah Data Peminjaman</h4>
                <form action="?module=aksi_tambah_data_peminjaman" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="time" name="waktu" placeholder="Silahkan masukkan Waktu Peminjaman" maxlength="100">
                        </div>
                    </div>
                    <div class="form-group row">
