    ...
    <div class="col-sm-12">
        <div class="float-right page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="?module=peminjaman">Data Buku Peminjaman</a></li>
                <li class="breadcrumb-item active">Edit Data Buku Peminjaman</li>
            </ol>
        </div>
...
<div class="row">
    <div class="col-12">
        <div class="card m-b-30">
            <div class="card-body">
                <h4 class="mt-0 header-title">Form Edit Data Peminjaman</h4>
                <?php
                    $id = $_GET['id'];
                ...
                ?>
                <form action="?module=aksi_edit_data_peminjaman" method="post">
