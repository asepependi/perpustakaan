<?php
    ...
    {
        $sql = "INSERT INTO pengembalian set id_anggota='$anggota', id_staff='$staff', tanggal='$tanggal', waktu='$waktu'";
        if (mysqli_query($conn, $sql)) {
            $_SESSION['message'] = "Pengembalian berhasil disimpan !";
            ...
            header('Location: ?module=tambah_data_pengembalian');
        }
        mysqli_close($conn);
    }
?>